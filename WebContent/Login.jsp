...
<body>
    ...
    <section style="background-color: #772f1a; background-image: linear-gradient(315deg, #772f1a 0%, #f2a65a 74%); height: 560px;">
        <div style="height: 80px;"></div>
        <div class="d-flex justify-content-center align-items-center">
            <div>
                <div class="account-wall" style="width: 400px;">
                    <img class="profile-img" src="${pageContext.request.contextPath}/frontend/assets/images/default_male.jpg" alt="">
