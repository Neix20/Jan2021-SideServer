...
// 			$('.dataTables_length').addClass('bs-select');
		...
		function openAddForm() {
			document.querySelector("#addCustomerModal").style.display = "block";
		}
		
		function closeAddForm() {
			document.querySelector("#addCustomerModal").style.display = "none";
		}
	</script>
</head>
	...
	<div class="table-title m-4 pb-2">
			<div class="row">
				<div class="col-sm-4 d-flex justify-content-start align-items-center">
					...
					<a href="#" class="btn btn-danger d-flex justify-content-center align-items-center" data-toggle="modal" data-target="#deleteCustomerModal">
					...
					<table class="table table-striped table-hover table-light scroll-bar">
						...
						<tbody>
							...
							for (Customer customer : customers) {
								...
								"href=\"CustomerServlet?id=" + customernumber + " \">"+
