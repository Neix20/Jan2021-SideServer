	...
	<div id="search_table">
		<%
			...
			if (!SearchResult.isEmpty())
				out.println("<script> $(function() { $(\"#search_table\").append(`" + table_html + "`); }); </script>");
		%>
	</div>
	...
	<form action="ProductServlet" method="post">
		<table class="table text-center" style="width: 600px;">
			<tbody>
				...
				<tr>
					<td><label for="productdescription">Product
			...
			<tbody>
				<tr>
					...
					<td><select name="productcode">
							<%
								for (Product p : list)
									out.println("<option value=\"" + p.getProductcode() + "\">" + p.getProductname() + "</option>");
							%>
					</select></td>
				</tr>
			</tbody>
