...
public class OrderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(downloadFile != null) downloadReport(request, response, customerHashMap);
	...
	public void downloadReport(HttpServletRequest request, HttpServletResponse response, HashMap<Integer, String> customerHashMap) throws IOException {
		List<Order> orderList = orderBean.getAllOrders();
